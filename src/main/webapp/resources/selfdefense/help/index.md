...
<h1 class="entry-title">SelfDefense codenjoy — как играть?</h1>
</header>
...
<p>Итак, игрок <a href="/codenjoy-contest/register?gameName=selfdefense">
регистрируется на сервере</a>, указывая свой email</p>
<p>Далее необходимо подключиться <a href="../../../resources/selfdefense/user/clients.zip">из кода</a>
